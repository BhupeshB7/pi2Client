...
const AdminDashboard = () => {
    ...
    const fetchActiveItemsCount = async () => {
      try {
        const response = await axios.get(
          `${apiUrl}/api/admin/count-active-items`
        );
  ...
  useEffect(() => {
    const fetchInActiveItemsCount = async () => {
      try {
        const response = await axios.get(
          `${apiUrl}/api/admin/count-inactive-items`
        );
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(
        `${apiUrl}/api/deposit/depositusers`
      );
  ...
  const handleWithdrawalSearch = async () => {
    ...
    const response = await fetch(
      `${apiUrl}/api/withdrawals?search=${withdrawalQuerySearch}`
    );
  ...
  const handleSearch = async () => {
    // Call the API endpoint with the search query parameter
    const response = await fetch(
      `${apiUrl}/api/admin/api/users?search=${searchQuery}`
    );
    const data = await response.json();
    setUsers(data);
  };
  ...
  const handleWithdrawalDelete = async (request) => {
    try {
      await axios.delete(
        `${apiUrl}/api/withdrawalWallet/${request._id}`
      );
  ...
  const handleFundApprove = async (userId) => {
    if (window.confirm("Are You Sure For Approve Fund?")) {
      try {
        await axios.post(
          `${apiUrl}/api/transfer/approve/${userId}`
        );
  ...
  const handleFundReject = async (userId) => {
    if (window.confirm("Are you sure?")) {
      try {
        await axios.post(
          `${apiUrl}/api/transfer/reject/${userId}`
        );
