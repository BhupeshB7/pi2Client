...
const AdminDashboard = () => {
    ...
    const fetchActiveItemsCount = async () => {
      try {
        const response = await axios.get(
          "https://mlm-eo5g.onrender.com/api/admin/count-active-items"
        );
  ...
  useEffect(() => {
    const fetchInActiveItemsCount = async () => {
      try {
        const response = await axios.get(
          "https://mlm-eo5g.onrender.com/api/admin/count-inactive-items"
        );
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(
        `https://mlm-eo5g.onrender.com/api/deposit/depositusers`
      );
  ...
  useEffect(() => {
    axios
      .get("https://mlm-eo5g.onrender.com/api/withdrawals")
  ...
  const handleWithdrawalSearch = async () => {
    ...
    const response = await fetch(
      `https://mlm-eo5g.onrender.com/api/withdrawals?search=${withdrawalQuerySearch}`
    );
  ...
  const handleApprove = async (id) => {
    try {
      const response = await axios.put(
        `https://mlm-eo5g.onrender.com/api/withdrawals/${id}`,
  ...
  const getUsers = async () => {
    const response = await axios.get(
      "https://mlm-eo5g.onrender.com/api/admin/api/users"
    );
  ...
  const handleSearch = async () => {
    // Call the API endpoint with the search query parameter
    const response = await fetch(
      `https://mlm-eo5g.onrender.com/api/admin/api/users?search=${searchQuery}`
    );
    const data = await response.json();
    setUsers(data);
  };
  ...
  const handleWithdrawalDelete = async (request) => {
    try {
      await axios.delete(
        `https://mlm-eo5g.onrender.com/api/withdrawalWallet/${request._id}`
      );
      ...
      {isTokenValid ? (
        ...
        {depositusers.map(user => (
          <li key={user._id}>
            ...
            <img src={`https://mlm-eo5g.onrender.com/${user.image}`} alt={user.name} />
          </li>
        ))}
      </ul> */}
                <div>
                      ...
                      <tbody>
                        {depositusers.map((user, index) => (
                          <tr key={user._id}>
                            ...
                            <td>
                              <img
                                src={`https://mlm-eo5g.onrender.com/${user.image}`}
                                alt="Deposit user"
                                width="100"
                                height="100"
                              />
