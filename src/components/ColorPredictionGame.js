...
//     try {
//       const response = await axios.post("https://mlm-gc1b.onrender.com/api/game/saveGame", gameDetails);
...
const userId = 'PI17218169';
  ...
  const getGamerProfile = async () => {
    try {
      const response = await axios.get(
        `https://mlm-gc1b.onrender.com/api/gameProfile/${userId}`
      );
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://mlm-gc1b.onrender.com/api/depositSubmit", {
        method: "POST",
        headers: {
  ...
  const fetchGameHistory = async () => {
    try {
      const response = await axios.get(
        `https://mlm-gc1b.onrender.com/api/game/history/${userId}`
      );
  ...
  const fetchWithdrawalHistory = async () => {
    try {
      const response = await axios.get(
        `https://mlm-gc1b.onrender.com/api/history/${userId}`
      );
  ...
  const fetchDepositHistory = async () => {
    try {
      const response = await axios.get(
        `https://mlm-gc1b.onrender.com/api/deposit/history/${userId}`
      );
...
//       try {
//         const response = await axios.post(
//           `https://mlm-gc1b.onrender.com/api/gameProfile/winningGame`,
//           {
//             userId: userId,
//             winnings: winnings,
//           }
...
//     try {
//       const response = await axios.post(
//         "https://mlm-gc1b.onrender.com/api/game/saveGame",
//         gameDetails
//       );
//       if (response.status === 201) {
//         console.log(gameDetails);
