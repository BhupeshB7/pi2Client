...
function AdminBalance() {
  ...
  const searchUser = async () => {
    try {
      const response = await axios.get(`https://mlm-gc1b.onrender.com/api/game/balance/${userId}`);
  ...
  const updateBalance = async () => {
    try {
      ...
      await axios.put(`https://mlm-gc1b.onrender.com/api/game/balance/${userId}`, { balance });
